...
export const GET_PRODUCTS_BEGIN = 'GET_PRODUCTS_BEGIN'; // for loading
export const GET_PRODUCTS_SUCCESS = 'GET_PRODUCTS_SUCCESS'; // when we get products and no error
export const GET_PRODUCTS_ERROR = 'GET_PRODUCTS_ERROR'; // to handle the error
